"""
Serializers for iron-cdn service.
"""
...
class ImageSerializer(serializers.ModelSerializer):
    ...
    original_url = serializers.SerializerMethodField(help_text='URL to original uploaded image')
    ...
    variant_720_jpg_url = serializers.ReadOnlyField(help_text='720px HD (JPEG fallback)')
    ...
    class Meta:
        model = Image
        fields = [
            'id', 'file_hash', 'original_filename', 'file_extension', 'type', 'prefix',
            'original_width', 'original_height', 'original_size',
            'original_url',
            'variant_16_url', 'variant_32_url', 'variant_64_url',
            'variant_120_url', 'variant_160_url', 'variant_240_url', 'variant_480_url',
            'variant_720_url', 'variant_720_jpg_url', 'variant_1080_url',
            'variant_1440_url', 'variant_2160_url',
            'is_processed', 'uploaded_by', 'uploaded_by_username',
            'created_at', 'updated_at'
        ]
        read_only_fields = [
            'file_hash', 'original_width', 'original_height', 'original_size',
            'type', 'is_processed', 'uploaded_by', 'created_at', 'updated_at'
        ]
...
class VideoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Video
        fields = [
            'id', 'file_hash', 'original_filename', 'file_extension',
            'original_width', 'original_height', 'original_size', 'duration',
            'original_url',
            'variant_16p_url', 'variant_32p_url', 'variant_240p_url',
            'variant_480p_url', 'variant_720p_url', 'variant_1080p_url',
            'variant_2160p_url',
            'is_processed', 'uploaded_by', 'uploaded_by_username',
            'created_at', 'updated_at'
        ]
...
class FileModelSerializer(serializers.ModelSerializer):
    ...
    original_url = serializers.SerializerMethodField(help_text='URL to original uploaded file')
    uploaded_by_username = serializers.CharField(source='uploaded_by.username', read_only=True)
    ...
    class Meta:
        ...
        fields = [
            'id', 'file_hash', 'original_filename', 'file_extension',
            'mime_type', 'original_size', 'prefix', 'original_url', 'refs',
            'uploaded_by', 'uploaded_by_username',
            'created_at', 'updated_at'
        ]
        read_only_fields = [
            'file_hash', 'original_size',
