...
pre-0.5.0 ``user.deleted`` account path around
:func:`stapel_cdn.erasure.erase` — one implementation of the protocol for
the fleet, and the ``alive`` answer still comes from the subscriber that
erases.
