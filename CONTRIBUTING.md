...
```bash
git clone https://github.com/usestapel/stapel-cdn.git && cd stapel-cdn
...
The packages use a flat layout (`package-dir = {{"stapel_cdn": "."}}`), so the
